...
/** 
   *@author ComparingIterator
 */
public class ComparingIterator {
 private static final Logger log=Logger.getLogger(ComparingIterator.class.getName());
 ...
 */
     public static void main(String[] args) throws IOException
      {
	ComparingIterator f=new ComparingIterator();
	while(true)
         { 
